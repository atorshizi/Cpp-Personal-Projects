...
class Graph {
    public:
        unordered_map<string,unordered_map<string,double>> nodesEdges;
        unsigned int numEdges;

        // vector<tuples<double,string,string>> edges;
        ...
        void recHelperCC(string start, vector<string> & comp, double const & threshold);
        /**
